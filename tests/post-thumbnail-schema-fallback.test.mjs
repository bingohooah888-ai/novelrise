...
test(
  'post thumbnails fail closed when no safe official source is available',
  () => {
...
test(
  'empty active composer catalog blocks posting unless a legacy official fallback exists',
  () => {
...
test(
  'thumbnail remains required through composer or legacy official asset',
  () => {
