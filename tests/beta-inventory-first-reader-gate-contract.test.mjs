...
test(
  'September 29 inventory gate stays read-only and requires a non-empty catalog',
  async () => {
...
test(
  'production reader smoke supports the strict inventory-gate mode without changing its default empty-catalog behavior',
  async () => {
...
test(
  'operations runbook defines the September 29 gate and keeps BETA_OPEN blocked on failure',
  async () => {
