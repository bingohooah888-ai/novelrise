...
test('all active official templates require cover_quad without PNG mask readiness', () => {
  ...
  assert.match(policy, /cover_top_left_x is not null/);
});
...
test('Chapter 40 rollback refuses lossy downgrade', () => {
