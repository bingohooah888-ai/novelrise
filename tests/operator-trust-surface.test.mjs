...
test(
  'operator information is public, complete, and aligned with the NOVELIGHT source of truth',
  () => {
...
test(
  'major logged-out public pages expose operator information in one click',
  () => {
...
test(
  'preregistration trust links are visible before the registration submit button',
  () => {
