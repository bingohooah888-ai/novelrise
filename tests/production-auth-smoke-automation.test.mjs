...
test(
  'production readiness automatically opens the next Auth Smoke approval request',
  () => {
...
test(
  'stale Production Auth Smoke approval recovers without another Run workflow click',
  () => {
