...
test(
  'classifies Stripe signature verification failures without logging the signature',
  () => {
    ...
    assert.equal(JSON.stringify(result).includes('secret-signature-value'), false);
  }
);
