...
test('SCOUT RECORD uses Author Studio shell and full beta information architecture', () => {
  ...
  assert.doesNotMatch(scout, /Badge Collection/u);
...
test('称号 UI includes percent + meter and mobile two-column grid', () => {
...
test('称号 difficulty accordions and Reader catalog are live', () => {
