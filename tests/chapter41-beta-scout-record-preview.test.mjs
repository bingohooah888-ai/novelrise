...
test('beta SCOUT RECORD is a locked low-data preview', () => {
  assert.match(preview, /<title>SCOUT RECORD βプレビュー \| NOVELIGHT<\/title>/u);
  ...
  assert.match(preview, /href="light-seed-history\.html">送信履歴を見る →<\/a>/u);
...
test('LIGHT SEED send history remains usable during beta and stays separate', () => {
  ...
  assert.match(history, /href="scout-record\.html">SCOUT RECORD βプレビューを見る →<\/a>/u);
