...
test(
  'Codex login classifier distinguishes ChatGPT, API key and workload identity',
  () => {
...
test(
  'Codex auth actions are fixed allowlist actions with confirmation-gated repair',
  async () => {
...
test(
  'Codex auth diagnostics report presence only for environment credentials',
  async () => {
