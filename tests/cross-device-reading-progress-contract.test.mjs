...
const continuityUrl = new URL(
  '../novelight-reading-continuity.js',
  import.meta.url
);
const homeResumeUrl = new URL('../novelight-home-resume.js', import.meta.url);
const migrationUrl = new URL(
  '../supabase/migrations/20260917150000_reader_reading_progress_sync.sql',
  import.meta.url
);
const precheckUrl = new URL(
  '../supabase/checks/20260917150000_reader_reading_progress_sync_precheck.sql',
  import.meta.url
);
const postcheckUrl = new URL(
  '../supabase/checks/20260917150000_reader_reading_progress_sync_postcheck.sql',
  import.meta.url
);
const rollbackUrl = new URL(
  '../supabase/rollback/20260917150000_reader_reading_progress_sync_rollback.sql',
  import.meta.url
);
