...
test('trusted exposure rollout keeps readers working before the DB migration without legacy authoritative writes', async () => {
  ...
  for (const page of [home, search]) {
    ...
    assert.doesNotMatch(page, /client\.rpc\('record_novel_impressions(?:_v2)?'/);
  }
