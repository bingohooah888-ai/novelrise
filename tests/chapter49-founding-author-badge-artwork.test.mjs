...
test('Founding Author limited badge renders the official artwork in SCOUT RECORD', async () => {
  ...
  has(js, "limited_founding_author: 'assets/founding-authors-badge-2026.png'");
