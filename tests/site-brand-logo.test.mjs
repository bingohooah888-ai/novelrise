...
test('public headers share the expanded pricing-style desktop composition', () => {
  assert.match(client, /grid-template-columns:auto minmax\(520px,1fr\) auto!important/u);
...
test('legacy app headers receive a larger reading floor and wider spacing', () => {
  ...
  assert.match(client, /header \.right>a\{font-size:16px!important;font-weight:700\}/u);
