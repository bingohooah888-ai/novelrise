(() => {
  const scoutRanks = Object.freeze([
    Object.freeze({ tier: 1, name: 'NOCTIS', minLevel: 1, maxLevel: 10 }),
    Object.freeze({ tier: 2, name: 'VESPER', minLevel: 11, maxLevel: 20 }),
    Object.freeze({ tier: 3, name: 'UMBRA', minLevel: 21, maxLevel: 30 }),
    Object.freeze({ tier: 4, name: 'ASTRA', minLevel: 31, maxLevel: 40 }),
    Object.freeze({ tier: 5, name: 'LUCENT', minLevel: 41, maxLevel: 50 }),
    Object.freeze({ tier: 6, name: 'AURELIS', minLevel: 51, maxLevel: 60 }),
    Object.freeze({ tier: 7, name: 'CELESTIA', minLevel: 61, maxLevel: 70 }),
    Object.freeze({ tier: 8, name: 'EMPYREAN', minLevel: 71, maxLevel: 80 }),
    Object.freeze({ tier: 9, name: 'SERAPH', minLevel: 81, maxLevel: 90 }),
  ...
  const titleNames = Object.freeze({
    ...
    'limited_founding_author': 'Founding Author',
    'limited_beta_participant': 'DAWNBOUND'
  });

  function rankForTier(value) {
    const tier = Math.max(1, Math.min(scoutRanks.length, Number(value || 1)));
    return scoutRanks[tier - 1];
  }
