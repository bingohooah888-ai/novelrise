-- Roll back only the 20260908153000 runtime-ordering repair by restoring the
-- immediately preceding plan-entitlement function definitions.

begin;

select pg_advisory_xact_lock(hashtext('novelrise:20260908153000:rollback'));
